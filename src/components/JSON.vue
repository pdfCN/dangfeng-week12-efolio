...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <ul>
        ...
        <li v-for="famousWork in allFamousWorks" :key="famousWork.title">
          《{{ famousWork.title }}》 ({{ famousWork.year }})
        </li>
      </ul>
    ...
    <section class="lab-section">
      ...
      <p>We operate in:
        <nobr v-for="country in bookstores.countries" :key="country">{{ country }}; </nobr>
      </p>
    ...
    <section class="lab-section">
      ...
      <ul>
        <li> Jane Austen </li>
        <li :style="{ color: textColor, background: backgroundColor, fontSize: fontSize + 'px' }"> George Orwell </li>
...
const allFamousWorks = computed(() =>
  authors.flatMap((author) => author.famousWorks)
);
